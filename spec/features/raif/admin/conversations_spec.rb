  ...
  describe "show page" do
    ...
    it "displays the conversation details and entries" do
      ...
      conversation.entries.each do |entry|
        expect(entry.sentinel_completion).to be_present
      ...
      expect(page).to have_link(
        I18n.t("sentinel.admin.common.view_completion"),
        href: sentinel.admin_completion_path(conversation.entries.first.sentinel_completion)
      )
