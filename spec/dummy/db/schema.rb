...
ActiveRecord::Schema[8.0].define(version: 2025_05_07_155314) do
  ...
  create_table "sentinel_agents", force: :cascade do |t|
    ...
    t.index ["created_at"], name: "index_sentinel_agents_on_created_at"
    t.index ["creator_type", "creator_id"], name: "index_sentinel_agents_on_creator"
  end
  ...
  create_table "sentinel_conversation_entries", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["created_at"], name: "index_sentinel_conversation_entries_on_created_at"
  ...
  create_table "sentinel_conversations", force: :cascade do |t|
    ...
    t.index ["created_at"], name: "index_sentinel_conversations_on_created_at"
  ...
  create_table "sentinel_model_completions", force: :cascade do |t|
    ...
    t.index ["created_at"], name: "index_sentinel_model_completions_on_created_at"
  ...
  create_table "sentinel_tasks", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["completed_at"], name: "index_sentinel_tasks_on_completed_at"
    t.index ["created_at"], name: "index_sentinel_tasks_on_created_at"
    t.index ["creator_type", "creator_id"], name: "index_sentinel_tasks_on_creator"
    t.index ["failed_at"], name: "index_sentinel_tasks_on_failed_at"
    t.index ["started_at"], name: "index_sentinel_tasks_on_started_at"
    t.index ["type", "completed_at"], name: "index_sentinel_tasks_on_type_and_completed_at"
    t.index ["type", "failed_at"], name: "index_sentinel_tasks_on_type_and_failed_at"
    t.index ["type", "started_at"], name: "index_sentinel_tasks_on_type_and_started_at"
