...
class Raif::ModelToolInvocation < Raif::ApplicationRecord
  belongs_to :sentinel_completion, class_name: "Raif::Completion", optional: true
  belongs_to :sentinel_agent_invocation, class_name: "Raif::AgentInvocation", optional: true
