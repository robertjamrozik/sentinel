...
module Raif
  class AgentInvocation < ApplicationRecord
    ...
    has_many :sentinel_model_completions, as: :source, dependent: :destroy, class_name: "Raif::ModelCompletion"
    ...
    validates :available_model_tools, length: {
      ...
      message: ->(_object, _data) {
        I18n.t("sentinel.agent_invocations.errors.available_model_tools.too_short")
      }
    }
    ...
    # agent_invocation = Raif::AgentInvocation.new(task: task, tools: [Raif::ModelTools::WikipediaSearch, Raif::ModelTools::FetchUrl], creator: creator)
